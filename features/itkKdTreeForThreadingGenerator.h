/*=========================================================================
  ...
  Module:    $RCSfile: itkKdTreeForThreadingGenerator.h,v $
  Language:  C++
...
=========================================================================*/
#ifndef __itkKdTreeForThreadingGenerator_h
#define __itkKdTreeForThreadingGenerator_h
...
#include "itkKdTreeForThreading.h"  // The only difference from the original itkKdTreeForThreadingGenerator.
#include "itkStatisticsAlgorithm.h"

namespace itk {
namespace Statistics {

/** \class KdTreeForThreadingGenerator
...
class ITK_EXPORT KdTreeForThreadingGenerator : public Object
{
public:
  /** Standard class typedefs */
  typedef KdTreeForThreadingGenerator          Self;
  typedef Object                   Superclass;
  typedef SmartPointer<Self>       Pointer;
  typedef SmartPointer<const Self> ConstPointer;

  /** Run-time type information (and related methods) */
  itkTypeMacro(KdTreeForThreadingGenerator, Object);
  ...
  typedef KdTreeForThreading< TSample > KdTreeType;
...
protected:
  /** Constructor */
  KdTreeForThreadingGenerator();

  /** Destructor */
  virtual ~KdTreeForThreadingGenerator() {}
...
private:
  KdTreeForThreadingGenerator(const Self&); //purposely not implemented
...
#include "itkKdTreeForThreadingGenerator.txx"
#endif
