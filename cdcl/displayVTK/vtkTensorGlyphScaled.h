/*=========================================================================
  ...
  Module:    $RCSfile: vtkTensorGlyphScaled.h,v $
...
=========================================================================*/
// .NAME vtkTensorGlyphScaled - scale and orient glyph(s) according to tensor eigenvalues and eigenvectors
// .SECTION Description
// vtkTensorGlyphScaled is a filter that copies a geometric representation
...
//
//
// Modified by Michal Sofka: The difference from the original vtkTensorGlyph
// is that this version uses square roots of eigenvalues rather then eigenvalues
// themselves. It would be better to derive from vtkTensorGlyph, but its structure
// would have to change (in VTK).
...
#ifndef __vtkTensorGlyphScaled_h
#define __vtkTensorGlyphScaled_h

#include "vtkPolyDataAlgorithm.h"

class VTK_GRAPHICS_EXPORT vtkTensorGlyphScaled : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkTensorGlyphScaled,vtkPolyDataAlgorithm);
  ...
  static vtkTensorGlyphScaled *New();
...
private:
  vtkTensorGlyphScaled(const vtkTensorGlyphScaled&);  // Not implemented.
  void operator=(const vtkTensorGlyphScaled&);  // Not implemented.
};
