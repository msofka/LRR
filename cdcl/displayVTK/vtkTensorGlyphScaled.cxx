/*=========================================================================
  ...
  Module:    $RCSfile: vtkTensorGlyphScaled.cxx,v $
...
vtkCxxRevisionMacro(vtkTensorGlyphScaled, "$Revision: 1.1 $");
vtkStandardNewMacro(vtkTensorGlyphScaled);

// Construct object with scaling on and scale factor 1.0. Eigenvalues are 
// extracted, glyphs are colored with input scalar data, and logarithmic
// scaling is turned off.
vtkTensorGlyphScaled::vtkTensorGlyphScaled()
{
  this->Scaling = 1;
...
int vtkTensorGlyphScaled::RequestData(
  ...
  vtkInformationVector *outputVector)
{
  ...
  for (inPtId=0; inPtId < numPts; inPtId++)
    ...
    for (dir=0; dir < numDirs; dir++) 
      ...
      // old behaviour of vtkTensorGlyphScaleds (which only used one dir), 
...
void vtkTensorGlyphScaled::SetSource(vtkPolyData *source)
{
  this->SetInput(1, source);
}

vtkPolyData *vtkTensorGlyphScaled::GetSource()
{
...
int vtkTensorGlyphScaled::FillInputPortInformation(int port, vtkInformation *info)
{
  if (port == 1)
    {
...
void vtkTensorGlyphScaled::PrintSelf(ostream& os, vtkIndent indent)
{
