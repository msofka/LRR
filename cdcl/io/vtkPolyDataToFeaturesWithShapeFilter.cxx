/*=========================================================================
  ...
  Module:    $RCSfile: vtkPolyDataToFeaturesWithShapeFilter.cxx,v $
...
vtkCxxRevisionMacro(vtkPolyDataToFeaturesWithShapeFilter, "$Revision: 1.2 $");
vtkStandardNewMacro(vtkPolyDataToFeaturesWithShapeFilter);

vtkStandardNewMacro(vtkFeatureWithShapeAttributeSet);
vtkCxxRevisionMacro(vtkFeatureWithShapeAttributeSet, "$Revision: 1.2 $");

//----------------------------------------------------------------------------
vtkPolyDataToFeaturesWithShapeFilter::vtkPolyDataToFeaturesWithShapeFilter()
{
...
void vtkPolyDataToFeaturesWithShapeFilter::SetInput(vtkPolyData *  input)
{
  this->vtkProcessObject::SetNthInput(0, input);
}

//----------------------------------------------------------------------------
void vtkPolyDataToFeaturesWithShapeFilter::SetOutput(AttributeSetType *output)
{
  this->GetExecutive()->SetOutputData(0, output);
}

//----------------------------------------------------------------------------
void vtkPolyDataToFeaturesWithShapeFilter::Execute()
{
  this->GenerateOutput();
}
...
//----------------------------------------------------------------------------
// Specify the input data or filter.
vtkPolyData *vtkPolyDataToFeaturesWithShapeFilter::GetInput()
{
...
////----------------------------------------------------------------------------
//// Specify the input data or filter.
//void vtkPolyDataToFeaturesWithShapeFilter::SetInput(vtkPolyData const &  input)
//{
//  this->vtkProcessObject::SetNthInput(0, input);
//}
//
////----------------------------------------------------------------------------
//// Specify the input data or filter.
//AttributeSetType *vtkPolyDataToFeaturesWithShapeFilter::GetInput()
//{
//  if (this->NumberOfInputs < 1)
//    {
//    return NULL;
...
//----------------------------------------------------------------------------
vtkPolyDataToFeaturesWithShapeFilter::AttributeSetType *vtkPolyDataToFeaturesWithShapeFilter::GetOutput()
{
...
void vtkPolyDataToFeaturesWithShapeFilter::Update()
{
  this->GenerateOutput();
}
...
void vtkPolyDataToFeaturesWithShapeFilter::GenerateOutput()
{
  ...
  if ( inputModified )
    ...
    for( vtkIdType  i = 0; i < vtkpoints->GetNumberOfPoints(); ++i ) {
      ...
      if( covariances ) {
        ...
        covariance.set( covarianceArray );
      }
      ...
      #if HAS_DIRECTIONS
      FeaturePointer  feature = new FeatureType( location, strength, covariance, errorProjector, shape, directions );
      #else
      FeaturePointer  feature = new FeatureType( location, strength, covariance, errorProjector, shape );
      #endif
...
void vtkPolyDataToFeaturesWithShapeFilter::ComputeInputUpdateExtents(vtkDataObject *output)
{
...
//----------------------------------------------------------------------------
int vtkPolyDataToFeaturesWithShapeFilter
...
//----------------------------------------------------------------------------
void vtkPolyDataToFeaturesWithShapeFilter::PrintSelf(ostream& os, vtkIndent indent)
{
